package com.gmail.coliveira.christian.colecao.login;
...
import com.gmail.coliveira.christian.colecao.CarregaSistema;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (usuarioAtual != null) {
            startActivity(new Intent(LoginActivity.this, CarregaSistema.class));
        }
    }
