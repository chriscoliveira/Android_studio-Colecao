...
public class NotasBr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_listagemnotbr);
        ...
        MostrarDados.setOnItemLongClickListener(new OnItemLongClickListener() {
            public boolean onItemLongClick(AdapterView<?> arg0, View view, int posicao, long arg3) {
                ...
                zinfodb.dialog(NotasBr.this, "atz", "Nota", "Editar Nota");
                zinfodb.enviaDadosDialog(NotasBr.this, zinfodb.NOME_TABELA, pos);
                return false;
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_AnoAZ:
                zinfodb.CarregaOrdenado(this, "Nota", "ano asc", "Brasil");
                return true;
            case R.id.menu_AnoZA:
                zinfodb.CarregaOrdenado(this, "Nota", "ano desc", "Brasil");
                return true;
            case R.id.menu_ID_AZ:
                zinfodb.CarregaOrdenado(this, "Nota", "_id asc", "Brasil");
                return true;
            case R.id.menu_ID_ZA:
                zinfodb.CarregaOrdenado(this, "Nota", "_id desc", "Brasil");
                return true;
            case R.id.menu_Por_Moeda_az:
                zinfodb.CarregaOrdenado(this, "Nota", "moeda asc", "Brasil");
                return true;
            case R.id.menu_Diametro:
                zinfodb.CarregaOrdenado(this, "Nota", "diametro asc", "Brasil");
                return true;
            case R.id.menu_Material:
                zinfodb.CarregaOrdenado(this, "Nota", "material asc", "Brasil");
                return true;
            case R.id.menu_Krause:
                zinfodb.CarregaOrdenado(this, "Nota", "krause asc", "Brasil");
                return true;
            default:
